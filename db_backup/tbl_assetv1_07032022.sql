...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2022 at 01:18 PM
...
('CATE_6225f6dd2b1b5', 'Laptup', 'LAPT', 4, '', 0);
...
('MODLNO_6225e0716c513', 'MODL_6225dfc9d893e', '3420', '', 1),
('MODLNO_6225e136a8fe6', 'MODL_6225dfc9d893e', '3420', '', 0),
('MODLNO_6225e1402a0b5', 'MODL_6225dfc9d893e', '3421', '', 0);
...
('MODL_6225dfc9d893e', 'Latitude', '', 0),
('MODL_6225e017f25ee', 'Vostro', '', 1),
('MODL_6225e0383d1fb', 'Vostro', '', 0);
...
('STS_6225df60b5c45', 0, 'Instore1', 1),
('STS_6225dfa4a1c81', 0, 'Instore', 0);
...
--
ALTER TABLE `tbl_users_log`
  MODIFY `userslogs_uid` bigint(20) NOT NULL AUTO_INCREMENT;
COMMIT;
