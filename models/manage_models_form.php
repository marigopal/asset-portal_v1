                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="models_name" name="models_name" onclick = "input_remove_error_notification('models_name')">
                            </div>
                        </div>
                    </div>
                    <div class="row d-flex justify-content-center">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-primary" id="savemodelsbutton" name="savemodelsbutton" onclick="save_modelname()">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="js/model_form.js" type="text/javascript"></script>
